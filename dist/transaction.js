...
var Transaction = /** @class */ (function () {
    function Transaction(fimksdk, recipientOrRecipientPublicKey, builder) {
        this.fimksdk = fimksdk;
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (utils_1.isDefined(_this.publicMessage_)) {
                ...
                if (isPrivate_1 || isPrivateToSelf_1) {
                    ...
                    crypto_1.encryptMessage(isPrivate_1 ? _this.privateMessage_ : _this.privateMessageToSelf_, recipientPublicKeyHex, secretPhrase).then(function (encryptedMessage) {
                        if (isPrivate_1) {
